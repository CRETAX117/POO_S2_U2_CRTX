...
public class PruebaSubclases {
    ...
    public static void main(String[] args) {
        ...
        // === YouTubeVideo y TikTokVideo ===
        YouTubeVideo yt1;
        YouTubeVideo yt2;
        TikTokVideo tk1;
        TikTokVideo tk2;
        try {
            yt1 = new YouTubeVideo("Ciencia real detrás de Dr. Stone", 18, "Documental", "Toho", 1_200_000, 98_000);
            yt1.addColaborador(colaborador1);
            yt1.addColaborador(colaborador2);

            yt2 = new YouTubeVideo("Análisis de Mr. Robot", 12, "Tecnología", "TechLab", 350_000, 12_000);
            yt2.addColaborador(protagonista1);

            tk1 = new TikTokVideo("Hack de Elliot en 30s", 30, "Thriller", "mrrobot", 8_500_000, 750_000, 120_000, protagonista1);
            tk2 = new TikTokVideo("Cómo arreglar todo sin hablar", 15, "Comedia", "khaby.lame", 60_000_000, 3_200_000, 850_000, protagonista2);
        } catch (util.DuracionInvalidaException e) {
            System.err.println("Error al crear videos: " + e.getMessage());
            return;
        }
